...
const register = async (req, res) => {
    try {
        const { name, email, password, role, contact, address, donor_type, receiver_type } = req.body
        ...
        const newUser = new UserModel({
            name, email, password: hasepassword, role, contact, address, donor_type, receiver_type
        })
